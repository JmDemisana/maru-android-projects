...
public final class HelperElevationManager {
    ...
    public static JSONObject getStemModelState(Context context) {
        ...
        try {
            ...
            boolean bundled = HelperStemVocalReducer.hasBundledModel(context);
            ...
            payload.put(
                "label",
                downloadedOverride
                    ? "Downloaded stem ready"
                    : bundled
                        ? "Bundled with this helper build"
                        : "Missing from this helper build"
            );
            payload.put(
                "note",
                downloadedOverride
                    ...
                    : bundled
                        ...
                        : "This helper build does not currently include the karaoke stem model."
            );
