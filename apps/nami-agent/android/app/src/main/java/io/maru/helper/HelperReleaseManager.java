...
public final class HelperReleaseManager {
    ...
    private static final String HELPER_APK_FILENAME = "maru.apk";
    private static final String USER_AGENT = "Maru/1.0";
    ...
    public static ReleaseAssetInfo fetchLatestHelperReleaseAsset() throws Exception {
        ...
        if (asset == null) {
            throw new IllegalStateException("The latest mobile release does not include maru.apk.");
        }
        return asset;
    }
