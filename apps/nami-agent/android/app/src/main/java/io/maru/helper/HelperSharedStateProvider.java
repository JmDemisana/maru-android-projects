...
public final class HelperSharedStateProvider extends ContentProvider {
    ...
    public static final String METHOD_GET_ACCOUNT_TOKEN = "getAccountToken";
    ...
    public Bundle call(@NonNull String method, @Nullable String arg, @Nullable Bundle extras) {
        ...
        if (METHOD_GET_ACCOUNT_TOKEN.equals(method)) {
            result.putString(KEY_VALUE, HelperStorage.getAccountToken(context));
            return result;
        }
