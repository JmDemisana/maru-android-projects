...
$apkDir = "D:\projects\maru-android-projects\apps\manime\build\outputs\apk\debug"
$origApk = (Get-Item "$apkDir\manime-debug.apk").FullName
$workingApk = "$apkDir\manime-patched.apk"
Copy-Item $origApk $workingApk -Force

$tempDir = "D:\projects\maru-android-projects\apps\manime\build\temp_so"
...
$alignedApk = "$apkDir\manime-16kb.apk"
...
Write-Host "Signed 16KB APK complete"
...
Write-Host "Zipalign verify exit code: $LASTEXITCODE"
